...
@media (max-width:480px){
    ...
    /* footer: alinhar botão Jogar e link Ver prêmios lado a lado */
    .scratch-card .card-footer{
        display:flex;
        flex-wrap:nowrap;
        align-items:center;
        justify-content:space-between;    /* empurra cada um para uma ponta */
        gap:.6rem;
        flex-direction:row;               /* sobrescreve o column anterior */
    }
    .scratch-card .play-button{
    ...
    .scratch-card .view-prizes{
        font-size:.75rem;
        line-height:1;
        margin-left:auto;                 /* garante alinhamento à direita se precisar */
        flex:0 0 auto;
    }
}
